...
## Corpus Check
- 362 files · ~343,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4410 nodes · 7645 edges · 272 communities (249 shown, 14 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 274 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `607e6fe7`
...
## Communities (272 total, 14 thin omitted)
...
Cohesion: 0.10
Nodes (26): betweenLabel(), clipName(), imageA, imageB, TransitionsPanel(), BetweenTransition, clampTransitionDuration(), ClipLike (+18 more)
...
Cohesion: 0.06
Nodes (51): ExportPanel(), FPS_OPTIONS, FpsOption, PLATFORM_PRESETS, PlatformPreset, WorkspaceOverview(), kindOf(), MediaPanel() (+43 more)
...
### Community 59 - "groq_transcribe.py"
Cohesion: 0.06
Nodes (34): _call_groq_transcribe(), _get_api_key(), list_models(), _parse_groq_response(), get, Request, UploadFile, Groq Whisper transcription — cloud-based, fast, free tier. (+26 more)
...
Cohesion: 0.07
Nodes (18): AutoCaptionsPanel(), formatTimestamp(), LANGUAGES, CaptionPanel(), downloadAs(), ExtractedImage, ExtractedPage, ExtractorPanel() (+10 more)
...
Cohesion: 0.06
Nodes (50): transcript, voice, MOTION_TYPES, MotionPanel(), applyClips(), clipWith(), imageAsset, videoAsset (+42 more)
...
Cohesion: 0.11
Nodes (44): get_config(), error_response(), _all_presets(), api_error_handler(), _builtin_by_id(), ClipMetadata, create_preset(), create_proxy() (+36 more)
...
### Community 105 - "TemplateEditorPanel.test.tsx"
Cohesion: 0.11
Nodes (24): FLAGS, TemplateEditorPanel(), overwrite(), patch(), saveAsNew(), selectBase(), builtin, custom (+16 more)
...
Cohesion: 0.10
Nodes (14): DEFAULT_BASE_URL, detectProvider(), FFmpegProvider, FontRenderInfo, HttpFFmpegProvider, RENDER_TIMEOUT_MS, RenderCaption, RenderCaptionStyle (+6 more)
...
Cohesion: 0.08
Nodes (49): _candidate_names(), clean_family_name(), _decode_name(), extract_family_name(), font_license_from_payload(), FontError, has_font_signature(), is_allowed_font_name() (+41 more)
...
Cohesion: 0.07
Nodes (30): add_panel(), adjust_panel(), delete_panel(), _fresh_id(), merge_panels(), M7 module 5: pure panel correction ops (module 5 slice 2). Split / Merge /…, Replace one panel's bounds (crop/expand within the source). The new box must…, Insert a user-defined panel (near-certain: confidence 1.0). The new panel gets… (+22 more)
...
Cohesion: 0.08
Nodes (67): Config, Lava Studio media sidecar package., probe_endpoint(), _ass_filter_string(), BetweenSpec, build_transition_graph(), check_binary(), EdgeSpec (+59 more)
...
Cohesion: 0.07
Nodes (36): MatchPanel(), Beat, labelFor(), PAUSE_BEAT_THRESHOLD, resegmentBeats(), segmentBeats(), splitSegment(), stableBeatId() (+28 more)

### Community 127 - "load_analysis_image"
Cohesion: 0.10
Nodes (19): _analysis_array(), _bg_estimate(), load_analysis_image(), Image, ndarray, Background color = mode of the 1px outer ring (comic margins). Panels carry…, Convert to gray float analysis image; returns (gray, ana_w, ana_h, factor).…, Decode ``image`` to a float32 RGB array at ``size`` (draft when possible). (+11 more)
...
Cohesion: 0.15
Nodes (20): CaptionStyle, BUILTIN_CATEGORIES, captionStyleFromPreset(), isCategory(), parsePreset(), Preset, PresetCategory, good (+12 more)
...
### Community 144 - "ApiError"
Cohesion: 0.09
Nodes (28): ApiError, Exception, Consistent error semantics for the sidecar API., EmbedFailure, _get_matcher(), match(), _parse_beats(), Exception (+20 more)
...
Cohesion: 0.09
Nodes (36): Path, Cross-platform file system helpers., Remove a directory tree, with Windows-friendly retry logic. On Windows, files…, rmtree_safe(), apply_correction(), _apply_panels(), delete_strip(), export_strip() (+28 more)
...
Cohesion: 0.13
Nodes (25): ASPECT_RATIOS, AspectRatio, TopBar(), TopBarProps, isAsset(), isClip(), isRecord(), isTrack() (+17 more)
...
Cohesion: 0.12
Nodes (15): attribute_confidence(), _boxes_overlap(), _certain_confidence(), guard_layout(), order_panels(), M7 module 3: reading order, confidence attribution, layout guards. Pure data…, Sort into natural top→bottom reading order and renumber `order` 1..n. Sort key…, Attach each panel a confidence equal to its two bounding boundaries' min.… (+7 more)
...
### Community 162 - "purge_stale_proxies"
Cohesion: 0.19
Nodes (15): GcReport, _proxy_files(), purge_stale_proxies(), Path, Garbage collection for regenerable disk caches. Only artifacts that are derived…, Proxy-labelled files only; stray files in the dir are never collected., Delete proxy files not accessed within `ttl_days` (default: config). Names not…, _cfg() (+7 more)
...
### Community 174 - "TrackRow.tsx"
Cohesion: 0.22
Nodes (11): DragMode, TimelinePanel(), TrackRow(), TransitionOverlay(), clamp(), emit(), getSnapshot(), listeners (+3 more)
...
Cohesion: 0.11
Nodes (24): attachPauses(), buildNodes(), confidenceLabel(), lowConfidence(), Node, TranscriptPanel(), StyleOption, STYLES (+16 more)
...
### Community 189 - "retention.ts"
Cohesion: 0.26
Nodes (8): analyzeRetention(), clipDurations(), hookStrength(), narrativeProgression(), pacingScore(), pacingVariation(), RetentionAnalysis, RetentionMetric
...
### Community 194 - "react"
Cohesion: 0.05
Nodes (31): App(), AIMatchPanel(), AIMatchTab, AssetCategory, AssetGrid(), sortRecent(), AssetsPanel(), BottomTab (+23 more)
...
### Community 198 - "test_manhwa_api.py"
Cohesion: 0.16
...
### Community 207 - "ManhwaPanel.tsx"
Cohesion: 0.14
Nodes (8): ManhwaPanel(), ManhwaPanelRow(), ManhwaPanelRowProps, stripDetail, stripSummary, CorrectionOp, panelImageUrl(), ManhwaStore
...
Cohesion: 0.19
Nodes (23): correctStrip(), deleteStrip(), getStrip(), listStrips(), ManhwaError, manhwaFetch(), ManhwaPanel, ManhwaStripDetail (+15 more)
...
### Community 219 - "InspectorPanel.tsx"
Cohesion: 0.14
Nodes (7): FontPanel(), LICENSE_TYPES, arial, ensureFontFace(), resetFontFaceRegistrations(), FONT_EXTENSIONS, fontPreviewUrl()

### Community 220 - "test_render_license.py"
Cohesion: 0.35
Nodes (12): font_entry(), make_image(), Path, Render-time font license guard + render font manifest (module 6, slice 2)., register_fonts(), render_captions(), test_render_allowed_import_lists_font_descriptor(), test_render_embedding_restricted_import_is_422() (+4 more)
...
Cohesion: 0.14
Nodes (15): _find_repo_root(), _payload(), Path, Resolve Lava Studio project-local configuration and paths., Walk up from *start* to find the repo root (has .git directory)., Resolve a binary path, trying .exe suffix on Windows., reset_config(), _resolve_binary() (+7 more)
...
### Community 231 - "HardwarePanel.tsx"
Cohesion: 0.24
Nodes (9): formatMB(), HardwareAnalysis, HardwarePanel(), HardwareSpecs, ModelAssessment, SCENARIO_META, formatSize(), ModelInfo (+1 more)
...
### Community 239 - "TestClient"
Cohesion: 0.20
Nodes (9): fonts_client(), fixture, client(), fixture, import_client(), fixture, license_client(), fixture (+1 more)
...
Cohesion: 0.07
Nodes (32): BulkGenerationPanel(), BulkResult, ClipperPanel(), ClipResult, GeneratedImage, ImageGenPanel(), AiTab, LeftWorkspaceProps (+24 more)
...
### Community 250 - "detect.py"
Cohesion: 0.26
Nodes (12): _bordered_by_content(), detect_cuts(), find_gutter_bands(), GutterBand, merge_slivers(), M7 module 2: hybrid panel detection (OpenCV + numpy). Operates on a downscaled…, Both immediate sides of the [start, end) run must be strong content., 1..SEAM_MAX_H flat empty runs between clean bands, bordered by content. (+4 more)

### Community 251 - "mix_sfx"
Cohesion: 0.47
Nodes (5): _find_sfx(), mix_sfx(), Any, Path, SFX mixer — layer sound effects via FFmpeg.

### Community 252 - "build_panels"
Cohesion: 0.35
Nodes (5): build_panels(), Cut, Convert analysis-space cuts into seam-free source-space incident panels. Cut…, validate_panels(), TestBuildPanels
...
### Community 269 - "TransitionOverlay.test.tsx"
Cohesion: 0.25
...
### Community 271 - "validate_layout"
Cohesion: 0.43
Nodes (3): Check a layout for the invariants every consumer cares about. Raises…, validate_layout(), TestValidateLayout

## Knowledge Gaps
- **1731 isolated node(s):** `$schema`, `plugin`, `lava-backend`, `$schema`, `plugins` (+1726 more)
...
- **Why does `ApiError` connect `ApiError` to `voice_cloning.py`, `main.py`, `image_gen.py`, `podcast_maker.py`, `auto_updater.py`, `video_clipper.py`, `generators.py`, `api.py`, `sound_fx.py`, `media.py`, `voice_library.py`, `groq_transcribe.py`, `post`, `timeline_sync.py`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `package.json`, `transitions.ts`, `PreviewPanel.tsx`, `TransitionOverlay.test.tsx`, `project.ts`, `PresetPanel.test.tsx`, `TrackRow.tsx`, `voice.ts`, `useEditorStore`, `fontStore.ts`, `ManhwaPanel.tsx`, `InspectorPanel.tsx`, `editorStore.ts`, `HardwarePanel.tsx`, `VoiceoverPanel.tsx`, `TemplateEditorPanel.test.tsx`, `ScriptWriterPanel.tsx`, `LeftWorkspace.tsx`, `matchingStore.ts`?**
...
- **Why does `AI Video Studio — Session Log` connect `AI Video Studio — Session Log` to `Session 17 — M6 module 4 `template-editor` (draft model, PUT overwrite, panel, render-path fix)`, `Session 18 — M6 module 5 `animated-captions` (ASS treatments + contract)`, `Session 19 — M6 module 6 `license-tracking` (render guard + manifest; M6 done)`, `Session 20 — M7 module 1 `panel-model` (frozen model, anchored mapping, git-clean registry) + CONSTRAINTS.md`, `Session 25 — M7 module 6 `manhwa-api` (backend complete)`, `Session 21 — M7 module 2 `panel-detection`: hybrid signals, rescue seams, source mapping, registry persistence`, `Session 22 — M7 module 3 `panel-order` (pure normalization layer) + modules 1–2 pushed`, `README.md`, `Session 2026-09-12 — Milestone 0 bootstrap + Milestone 1 media foundation`, `Session 23 — M7 module 4 `panel-export` (full-res crops + manifest)`, `Session 28 — M9 hardware validation plan + module 1 `proxy-preview` (4 slices)`, `Session 26-27 — M7 panel-ui + M8 integrated editor (slices 1–4)`, `Session 24 — M7 module 5 `panel-correction` (pure list ops) + export order fix`, `Session 29 — M9 module 2 `runtime-optimization` (5 slices)`, `Session 30 — M9 module 3 `memory-tuning` (5 slices)`, `Session 31 — M9 module 4 `baseline-validation` (4 slices)`, `Session 32 — M9 reframe: validation machine-agnostic (D-037)`, `Session 39 — Polish Phase: Accessibility, Responsive, Error/Loading, Docs`, `Session 2026-09-12 — Session 2: continuity system + commit discipline`, `Session 2026-09-12 — Session 3: media sidecar (real rendering)`, `Session 2026-09-12 — Session 4: M1 completion (save/load + clip editing)`, `Session 2026-09-12 — Session 5: M2 voice analysis (first slice)`, `Session 2026-09-12 — Session 6: M3 semantic image matching (first slice)`, `Session 34 — V2 Frontend: Topbar + Nav Rail + Left Workspace`, `Session 12 — M4 module 4: image-motion (Ken Burns/drift on stills)`, `Session 35 — V2 Frontend: Right Panels (AI Match + Auto Captions)`, `Session 38 — Remaining Features + Regression Audit + Polish Prep`, `Session 2026-09-12 — Session 7: M3 remainder — timing fit + manual timing override`, `Session 40 — V2 Frontend Gap Fixes: Phase 1 (Quick Fixes) + Timeline Zoom + Snapping + Drag-to-Timeline + Export Presets + Keyboard Shortcuts + Play Button Fix`, `Session 2026-09-12 — Session 8: M3 final pass — multilingual image matching (Urdu/Roman-Urdu)`, `Session 42 — V2 Frontend Gap Fixes: Phase 3 (Timeline Visuals)`, `Session 41 — V2 Frontend Gap Fixes: Phase 2 (Preview Controls)`, `Session 43 — V2 Frontend Gap Fixes: Phase 4 (AI Match Visual)`, `Session 44 — V2 Frontend Gap Fixes: Phase 5 (Extractor Fixes)`, `Session 2026-09-12 — Session 9: M4 module 1 — transitions-core`, `Session 47 — Manhwa PDF Import + Panel Detection`, `Session 2025-09-20 — M11 Implementation Complete (Phases 1-8)`, `Session 2026-09-12 — Session 10: M4 module 2 — transitions-render`, `Session 33 — Beta impression (D-038)`, `Session 2026-09-12 — Session 11: M4 module 3 — transitions-ui`, `Session 13 — M5 caption engine complete (all four modules)`, `Session 15 — M6 module 2: preset-registry shipped (13 categories, one-click apply)`, `Session 49 — AutoCut Studio PRO + Clabeo Feature Parity Planning`, `Session 14 — M6 module 1: font-system shipped (spec → plan → TDD slices → docs)`, `Session 48 — Desktop Editor Shell and Transport Hardening`, `Session 16 — M6 module 3 `preset-import` (import/export/delete + Custom writes)`, `Session 37 — V2 Frontend: Presentation/Image Extractor`, `Session 45 — V2 Frontend Gap Fixes: Phase 6 (Image-to-Image)`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Are the 39 inferred relationships involving `ApiError` (e.g. with `download_zip()` and `generate_bulk()`) actually correct?**
  _`ApiError` has 39 INFERRED edges - model-reasoned connections that need verification._
