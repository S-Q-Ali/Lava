...
def _scan_models() -> list[ModelInfo]:
    ...
    models = [
        ModelInfo(
            id="whisper-tiny",
            name="Whisper Tiny",
            description="Fastest transcription (~75MB). Real-time on low-end hardware.",
            directory="models/whisper/tiny",
            size_mb=75,
            download_source="huggingface",
            download_url="Systran/faster-whisper-tiny",
            download_command="",
        ),
        ModelInfo(
            id="whisper-small",
            name="Whisper Small",
            description="Balanced model (~500MB). Good accuracy, works on most hardware.",
            directory="models/whisper/small",
            size_mb=500,
            download_source="huggingface",
            download_url="Systran/faster-whisper-small",
            download_command="",
        ),
        ModelInfo(
            id="whisper-distil-large-v3",
            name="Whisper Distil Large v3",
            description="Near large-v3 accuracy, ~3x faster (~800MB). Best speed/quality.",
            directory="models/whisper/distil-large-v3",
            size_mb=800,
            download_source="huggingface",
        ...
        ModelInfo(
            ...
            description="Same accuracy as large-v3, 2-3x faster (~1.6GB). Best overall.",
            directory="models/whisper/large-v3-turbo",
            size_mb=1600,
            download_source="huggingface",
            download_url="mobiuslabsgmbh/faster-whisper-large-v3-turbo",
            download_command="",
        ),
        ModelInfo(
            id="clip",
